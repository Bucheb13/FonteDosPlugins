...
export default function PaginaAdminDaws() {
  ...
  async function criar() {
    ...
    // ✅ instalação opcional (só manda se tiver conteúdo)
    ...
    // se não tiver conteúdo -> não manda nada (vira NULL no backend)
