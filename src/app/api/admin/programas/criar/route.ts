...
export async function POST(req: Request) {
  ...
  await registrarAuditoriaAdmin(req, { acao: "POST", entidade: "programas/criar" });
  ...
  if (existente) {
    return jsonErro("Já existe um programa com esse slug.");
  }
  ...
  if (error) {
    ...
    return jsonErro("Erro ao criar o programa.");
  }
